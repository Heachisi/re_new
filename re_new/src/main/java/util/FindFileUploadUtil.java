...
public class FindFileUploadUtil {
     ...
     */
    public static List<FindPostFile>  uploadFiles(List<Part> parts, String basePath, int boardId, String userId) throws IOException {
        List<FindPostFile> files = new ArrayList<>(); // 업로드된 파일명을 저장할 리스트
