...
public class BulletinFileUploadUtil {
     ...
     */
    public static List<BulletinPostFile>  uploadFiles(List<Part> parts, String basePath, int boardId, String userId) throws IOException {
        List<BulletinPostFile> files = new ArrayList<>(); // 업로드된 파일명을 저장할 리스트
        ...
        BulletinPostFile postFile = null;
        // 업로드된 각 파일에 대해 처리
        for (Part part : parts) {
