...
public class FindFileController extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5939703672566257803L;
	private static final Logger logger = LogManager.getLogger(FindFileController.class);
	private BulletinFileService fileService;

	public FindFileController() {
		super();
